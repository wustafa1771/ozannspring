...
Conversationepository conversationepository;
    ...
    @Override
    public double conversion(ConversationRequest conversationRequest) {
        ...
        conversationResponse.setTargetAmount(conversationRequest.getAmout()*exchangeRate);
        conversationepository.save(conversationResponse);
        List<ConversationResponse> conversationResponseList = conversationepository.findAll();
        return conversationResponse.getTargetAmount();
    }
}
